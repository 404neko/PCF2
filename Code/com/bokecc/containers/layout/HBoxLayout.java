package com.bokecc.containers.layout {
    ...
    public class HBoxLayout extends Layout {
        ...
        public static const NAME:String = "HBoxLayout";

        public function HBoxLayout(_arg1:Container){
            super(_arg1);
        }
        ...
        override public function updateLayout():void{
            ...
            var _local2:String = _local1.verticalAlign;
            ...
            var _local7:Number = _local1.horizontalGap;
            var _local8:Number = _local3;
            var _local9:int;
            while (_local9 < _local1.numChildren) {
                _local10 = _local1.getChildAt(_local9);
                if (_local2 == Align.TOP){
                    _local10.y = _local5;
                };
                if (_local2 == Align.BOTTOM){
                    _local10.y = (_local1.height - (_local6 + _local10.height));
                };
                if (_local2 == Align.CENTER){
                    _local11 = (0.5 * (_local1.height - _local10.height));
                    if (_local11 < _local5){
                        _local11 = _local5;
                    };
                    _local10.y = _local11;
                ...
                _local8 = ((_local8 + _local10.width) + _local7);
                _local9++;
            };
        }
