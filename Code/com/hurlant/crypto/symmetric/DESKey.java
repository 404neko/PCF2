package com.hurlant.crypto.symmetric {
    ...
    public class DESKey implements ISymmetricKey {
        ...
        protected function generateWorkingKey(_arg1:Boolean, _arg2:ByteArray, _arg3:uint):Array{
            ...
            if (false){
                5;
                !(((_arg2[(_arg3 + (_local7 >>> 3))] & bytebit[(_local7 & 7)]) == 0));
                _local8;
                _local5;
            } else {
            ...
            var _temp1 = _local8;
            var _temp2 = !(((_arg2[(_arg3 + (_local7 >>> 3))] & bytebit[(_local7 & 7)]) == 0));
            _local8 = (_local8 + 1);
            //unresolved if
            var _local9:uint;
            if (_local9 >= 16){
            ...
            if (_local6[pc2[_local8]]){
                if (false){
                    5;
                    (_local4[_local10] | bigbyte[_local8]);
                    _local10;
                    _local4;
                } else {
            ...
            if (_local6[pc2[(_local8 + 24)]]){
                if (false){
                    5;
                    (_local4[_local11] | bigbyte[_local8]);
                    _local11;
                    _local4;
                } else {
            ...
            if (false){
                5;
                (((((_local12 & 0xFC0000) << 6) | ((_local12 & 4032) << 10)) | ((_local13 & 0xFC0000) >>> 10)) | ((_local13 & 4032) >>> 6));
                _local9;
                _local4;
            } else {
            ...
            if (false){
                5;
                (((((_local12 & 258048) << 12) | ((_local12 & 63) << 16)) | ((_local13 & 258048) >>> 4)) | (_local13 & 63));
                (_local9 + 1);
                _local4;
            } else {
            ...
            var _temp3 = _local9;
            var _temp4 = (((((_local12 & 0xFC0000) << 6) | ((_local12 & 4032) << 10)) | ((_local13 & 0xFC0000) >>> 10)) | ((_local13 & 4032) >>> 6));
            var _temp5 = (_local9 + 1);
            var _temp6 = (((((_local12 & 258048) << 12) | ((_local12 & 63) << 16)) | ((_local13 & 258048) >>> 4)) | (_local13 & 63));
            _local9 = (_local9 + 2);
            //unresolved if
            return (_local4);
            /*not popped
